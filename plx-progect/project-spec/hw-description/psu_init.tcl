...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0030 0x00717F00 0x00014200
		# : BY PASS PLL
		# Register : RPLL_CTRL @ 0XFF5E0030</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x01752B07
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x0021E000
    ...
    mask_write 0XFF180160 0x03FFFFFF 0x03FFFFCF
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180320 0x00003384 0x00001080
		# : SD0 BASE CLOCK
