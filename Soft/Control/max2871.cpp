...
static uint32_t max_config[SIZE_MAX2871_CONFIG] = { // 80 MHz
    0x00800000,
    0x200103E9,
    0x12005F42,
    0x01009F23,
...
//static uint32_t max_config[SIZE_MAX2871_CONFIG] = { // 78
//    0x007C8258,
//    0x200103E9,
//    0x92005F42,
//    0x01009F23,
...
void MAX2871::writeToMAX2871(uint32_t data) {
    ...
    LE.out(1);
    usleep(50000);
    //std::cout << "writeToMAX2871 exit" << std::endl;
}
